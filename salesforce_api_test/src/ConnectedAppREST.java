...
//		System.out.println("Response Status line create account :" + closeableresponse.getStatusLine());  
//
////		try {
////
...
//	}
	...
	private void showAccount(String accountId, String instanceUrl,
		...
		try {
			...
			CloseableHttpResponse closeableresponse = httpclient.execute(httpGet);  
			System.out.println("Response Status line showAccount :" + closeableresponse.getStatusLine());  
